...
public class Graph_M
{
    ...
    public String display_Map() {
        ...
        mapData.append("\t Delhi Metro Map\n");
        mapData.append("\t------------------\n");
        mapData.append("----------------------------------------------------\n\n");
        ...
        for (String key : keys) {
            ...
            for (String nbr : vtxnbrs) {
                ...
                if (nbr.length() < 8)
                    str += "\t";
                str += "\t" + vtx.nbrs.get(nbr) + "\n";
            }
            mapData.append(str).append("\n");
        }
        mapData.append("\t------------------\n");
        mapData.append("---------------------------------------------------\n\n");
    ...
    // Add the loadMetroMapData method to load metro map data
    public void loadMetroMapData() {
        Create_Metro_Map(this);
    }

    // Include the Create_Metro_Map method here
    public static void Create_Metro_Map(Graph_M g) {
        // Add metro stations and edges here
    ...
    public String listAllStations() {
        StringBuilder stationListBuilder = new StringBuilder();
        ArrayList<String> keys = new ArrayList<>(vtces.keySet());

        for (String key : keys) {
            stationListBuilder.append(key).append("\n");
        }

        return stationListBuilder.toString();
    }
    ...
    public String findShortestPathDistance(String src, String dst)
    {
    ...
    public String Get_Minimum_Distance(String src, String dst) {
        ...
        // Convert the minimum distance to a string before returning
        return "Minimum distance from " + src + " to " + dst + ": " + Integer.toString(min) +"KM";
    }


    public String findShortestPathTime(String src, String dst) {
        int min = Integer.MAX_VALUE;
        String ans = "";
        HashMap<String, Boolean> processed = new HashMap<>();
        LinkedList<Pair> stack = new LinkedList<>();
    ...
    public String Get_Minimum_Time(String src, String dst) {
        ...
        Double minutes = Math.ceil((double) min / 60);
        ans = src + " to " + dst + ": " + minutes + " minutes";
        return ans;
    }
        ...
        while(true)
        {
            ...
            switch(choice)
            {
                case 1:
                    ...
                    String stationList = g.listAllStations();
